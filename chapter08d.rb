...
def englishNumber number
  ...
  left  = number
  write = left/1000000         #  千の桁以上の桁をwriteに入れます。
  left  = left - write*1000000 #  下3桁をleftに残します。
...
while number_of_bottles >= 0
  puts englishNumber(number_of_bottles).to_s + ' Bottles of beer on the wall'
  puts englishNumber(number_of_bottles).to_s + ' Bottles of beer'
